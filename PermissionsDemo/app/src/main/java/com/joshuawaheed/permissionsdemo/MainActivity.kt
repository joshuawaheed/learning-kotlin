package com.joshuawaheed.permissionsdemo
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCameraPermission.setOnClickListener {
            val buildVersionGreaterThanM = Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
            ...
            val showRequestCameraPermissionRationale = shouldShowRequestPermissionRationale(cameraPermission)

            if (buildVersionGreaterThanM && showRequestCameraPermissionRationale) {
                showRationaleDialog(
